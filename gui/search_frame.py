...
"color: rgb(0, 0, 0);")
        ...
        self.searchTab.setTabText(self.searchTab.indexOf(self.simpleSearchTab), "Búsqueda Simple")
        ...
        self.titleSearchEdit.setStyleSheet("font: 14pt \"Ubuntu Sans\";\n"
"color: rgb(0, 0, 0);")
        ...
        self.authorSearchEdit.setStyleSheet("font: 14pt \"Ubuntu Sans\";\n"
"color: rgb(0, 0, 0);")
        ...
        self.publisherSearchEdit.setStyleSheet("font: 14pt \"Ubuntu Sans\";\n"
"color: rgb(0, 0, 0);")
        ...
        self.categorySearchEdit.setStyleSheet("font: 14pt \"Ubuntu Sans\";\n"
"color: rgb(0, 0, 0);")
        ...
        self.isbnSearchEdit.setStyleSheet("font: 14pt \"Ubuntu Sans\";\n"
"color: rgb(0, 0, 0);")
        ...
        self.lccnSearchEdit.setStyleSheet("font: 14pt \"Ubuntu Sans\";\n"
"color: rgb(0, 0, 0);")
        ...
        self.oclcSearchEdit.setStyleSheet("font: 14pt \"Ubuntu Sans\";\n"
"color: rgb(0, 0, 0);")
        ...
        self.searchTab.setTabText(self.searchTab.indexOf(self.advancedSearchTab), "Búsqueda Avanzada")
    ...
    def events(self):
        self.keyPressEvent = lambda e: self.search() if e.key() == QtCore.Qt.Key.Key_Return else None
    ...
    def search(self):
        ...
        if not self.search_topic or search != self.search_topic or not self.cache_books or self.cache_books[(self.page - 1) * 10] == None:
            ...
            self.books = search_books(search, advanced_search=advanced_search, search_by_field=search_by_field, search_type=search_type, start_index=(self.page - 1) * 10)
